...
class AboutLicenseAttributionTest {
    ...
    private val PER_SCHOOL_ATTRIBUTIONS = listOf(
        ...
        // WakeUp 兼容协议族跨仓验证 (2026-09-15 SOP, 38 候选全量; 32 未致谢仓库首纳入)
        Attribution("Dawn-Course", "GPL-3.0"),
        Attribution("WakeUp_SHU", "ershiyidian"),
        Attribution("CourseHelper", "jiangyiqi99"),
        Attribution("aischedule-lit-kingosoft", "MIT"),
        Attribution("XiaoAISchedule_hebust", "web1n"),
        Attribution("ai-schedule-chaoxing", "MIT"),
        Attribution("tzvcst-schedule-chaoxing", "AGPL-3.0"),
        Attribution("xiaoai-shuwei-course", "ZKJJaker"),
        Attribution("jxufe-auto-evaluate", "wzj1122"),
        Attribution("KINGOSOFT-LOGIN", "52funny"),
        Attribution("xiaoaiSchedule", "xiaxiaoyu8"),
        Attribution("mi-schedule", "Kou-JunHao"),
        Attribution("AISchedule-xjsf", "ltxhhz"),
        Attribution("AIScheduleSCAU", "greyovo"),
        Attribution("MI_AI_Course_Schedule", "ceresOPA"),
        Attribution("AISchedule-QiangZhi", "MyLikeGirl"),
        Attribution("classpush", "sungithub270"),
        Attribution("XiaoAiScheduleOfSUOT", "trueWangSyutung"),
        Attribution("XiaoAiCurriculumSchedule", "LukeJean"),
        Attribution("getICS", "Konata09"),
        Attribution("WITClassScheduleToCalendar", "DOROMOLLL"),
        Attribution("CrawlerCourseTable", "canliture"),
        Attribution("SYU_KINGGOClassSel", "XTAI9"),
        Attribution("hait_AICourseTable", "zzzsq1"),
        Attribution("AIShedule_cqwu", "cqwu-ehall"),
        Attribution("WakeUpSchedule", "Daydream357"),
        Attribution("shike-android", "sw7943604-del"),
        Attribution("shiguang_Tester", "XingHeYuZhuan"),
        Attribution("dutsso", "yuanyuanzijin"),
